...
mod tests {
    ...
    fn test_turboshake128_ptn_1() {
        ...
        let expected: [u8; 32] = [
            0x55, 0xCE, 0xDD, 0x6F, 0x60, 0xAF, 0x7B, 0xB2, 0x9A, 0x40, 0x42, 0xAE, 0x83, 0x2E,
            0xF3, 0xF5, 0x8D, 0xB7, 0x29, 0x9F, 0x89, 0x3E, 0xBB, 0x92, 0x47, 0x24, 0x7D, 0x85,
            0x69, 0x58, 0xDA, 0xA9,
        ];
        let mut output = [0u8; 32];
    ...
    fn test_turboshake128_ptn_17() {
        ...
        let expected: [u8; 32] = [
            0x9C, 0x97, 0xD0, 0x36, 0xA3, 0xBA, 0xC8, 0x19, 0xDB, 0x70, 0xED, 0xE0, 0xCA, 0x55,
            0x4E, 0xC6, 0xE4, 0xC2, 0xA1, 0xA4, 0xFF, 0xBF, 0xD9, 0xEC, 0x26, 0x9C, 0xA6, 0xA1,
            0x11, 0x16, 0x12, 0x33,
        ];
        let mut output = [0u8; 32];
    ...
    fn test_turboshake128_ptn_289() {
        ...
        let expected: [u8; 32] = [
            0x96, 0xC7, 0x7C, 0x27, 0x9E, 0x01, 0x26, 0xF7, 0xFC, 0x07, 0xC9, 0xB0, 0x7F, 0x5C,
            0xDA, 0xE1, 0xE0, 0xBE, 0x60, 0xBD, 0xBE, 0x10, 0x62, 0x00, 0x40, 0xE7, 0x5D, 0x72,
            0x23, 0xA6, 0x24, 0xD2,
        ];
        let mut output = [0u8; 32];
    ...
    fn test_turboshake128_domain_sep_01() {
        ...
        let expected: [u8; 32] = [
            0xBF, 0x32, 0x3F, 0x94, 0x04, 0x94, 0xE8, 0x8E, 0xE1, 0xC5, 0x40, 0xFE, 0x66, 0x0B,
            0xE8, 0xA0, 0xC9, 0x3F, 0x43, 0xD1, 0x5E, 0xC0, 0x06, 0x99, 0x84, 0x62, 0xFA, 0x99,
            0x4E, 0xED, 0x5D, 0xAB,
        ];
        let mut output = [0u8; 32];
    ...
    fn test_turboshake256_ptn_1() {
        ...
        let expected: [u8; 64] = [
            0x3E, 0x17, 0x12, 0xF9, 0x28, 0xF8, 0xEA, 0xF1, 0x05, 0x46, 0x32, 0xB2, 0xAA, 0x0A,
            0x24, 0x6E, 0xD8, 0xB0, 0xC3, 0x78, 0x72, 0x8F, 0x60, 0xBC, 0x97, 0x04, 0x10, 0x15,
            0x5C, 0x28, 0x82, 0x0E, 0x90, 0xCC, 0x90, 0xD8, 0xA3, 0x00, 0x6A, 0xA2, 0x37, 0x2C,
            0x5C, 0x5E, 0xA1, 0x76, 0xB0, 0x68, 0x2B, 0xF2, 0x2B, 0xAE, 0x74, 0x67, 0xAC, 0x94,
    ...
    fn test_turboshake256_ptn_17() {
        ...
        let expected: [u8; 64] = [
            0xB3, 0xBA, 0xB0, 0x30, 0x0E, 0x6A, 0x19, 0x1F, 0xBE, 0x61, 0x37, 0x93, 0x98, 0x35,
            0x92, 0x35, 0x78, 0x79, 0x4E, 0xA5, 0x48, 0x43, 0xF5, 0x01, 0x10, 0x90, 0xFA, 0x2F,
            0x37, 0x80, 0xA9, 0xE5, 0xCB, 0x22, 0xC5, 0x9D, 0x78, 0xB4, 0x0A, 0x0F, 0xBF, 0xF9,
            0xE6, 0x72, 0xC0, 0xFB, 0xE0, 0x97, 0x0B, 0xD2, 0xC8, 0x45, 0x09, 0x1C, 0x60, 0x44,
    ...
    fn test_turboshake256_ptn_289() {
        ...
        let expected: [u8; 64] = [
            0x66, 0xB8, 0x10, 0xDB, 0x8E, 0x90, 0x78, 0x04, 0x24, 0xC0, 0x84, 0x73, 0x72, 0xFD,
            0xC9, 0x57, 0x10, 0x88, 0x2F, 0xDE, 0x31, 0xC6, 0xDF, 0x75, 0xBE, 0xB9, 0xD4, 0xCD,
            0x93, 0x05, 0xCF, 0xCA, 0xE3, 0x5E, 0x7B, 0x83, 0xE8, 0xB7, 0xE6, 0xEB, 0x4B, 0x78,
            0x60, 0x58, 0x80, 0x11, 0x63, 0x16, 0xFE, 0x2C, 0x07, 0x8A, 0x09, 0xB9, 0x4A, 0xD7,
    ...
    fn test_turboshake256_domain_sep_01() {
        ...
        let expected: [u8; 64] = [
            0xD2, 0x1C, 0x6F, 0xBB, 0xF5, 0x87, 0xFA, 0x22, 0x82, 0xF2, 0x9A, 0xEA, 0x62, 0x01,
            0x75, 0xFB, 0x02, 0x57, 0x41, 0x3A, 0xF7, 0x8A, 0x0B, 0x1B, 0x2A, 0x87, 0x41, 0x9C,
            0xE0, 0x31, 0xD9, 0x33, 0xAE, 0x7A, 0x4D, 0x38, 0x33, 0x27, 0xA8, 0xA1, 0x76, 0x41,
            0xA3, 0x4F, 0x8A, 0x1D, 0x10, 0x03, 0xAD, 0x7D, 0xA6, 0xB7, 0x2D, 0xBA, 0x84, 0xBB,
    ...
    fn test_turboshake256_domain_sep_0b() {
        ...
        let expected: [u8; 64] = [
            0xBB, 0x36, 0x76, 0x49, 0x51, 0xEC, 0x97, 0xE9, 0xD8, 0x5F, 0x7E, 0xE9, 0xA6, 0x7A,
            0x77, 0x18, 0xFC, 0x00, 0x5C, 0xF4, 0x25, 0x56, 0xBE, 0x79, 0xCE, 0x12, 0xC0, 0xBD,
            0xE5, 0x0E, 0x57, 0x36, 0xD6, 0x63, 0x2B, 0x0D, 0x0D, 0xFB, 0x20, 0x2D, 0x1B, 0xBB,
            0x8F, 0xFE, 0x3D, 0xD7, 0x4C, 0xB0, 0x08, 0x34, 0xFA, 0x75, 0x6C, 0xB0, 0x34, 0x71,
            0xBA, 0xB1, 0x3A, 0x1E, 0x2C, 0x16, 0xB3, 0xC0,
        ];
        let mut output = [0u8; 64];
        TurboShake256::hash_with_domain_sep(
