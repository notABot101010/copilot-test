...
function wasm_bindgen__convert__closures_____invoke__h4319133022181043(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h4319133022181043(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h255a89ae68d7021b(arg0, arg1, arg2, arg3, arg4) {
    wasm.wasm_bindgen__convert__closures_____invoke__h255a89ae68d7021b(arg0, arg1, arg2, arg3, arg4);
}

function wasm_bindgen__convert__closures_____invoke__h1c2f29fb06bfab95(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h1c2f29fb06bfab95(arg0, arg1, arg2, arg3);
}
 ...
 * @param {string} group_id
 * @param {string} invitee_key_package_b64
 * @returns {any}
 */
export function create_invite(group_id, invitee_key_package_b64) {
    const ptr0 = passStringToWasm0(group_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(invitee_key_package_b64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.create_invite(ptr0, len0, ptr1, len1);
    if (ret[2]) {
 ...
 * @returns {string}
 */
export function decrypt_message(group_id, ciphertext_b64) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(group_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.decrypt_message(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function encrypt_message(group_id, plaintext) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(group_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {any}
 */
export function generate_key_packages(count) {
    const ret = wasm.generate_key_packages(count);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {boolean}
 */
export function has_group_state(group_id) {
    const ptr0 = passStringToWasm0(group_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.has_group_state(ptr0, len0);
    return ret !== 0;
}
 ...
 */
export function init_mls(username) {
    const ptr0 = passStringToWasm0(username, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.init_mls(ptr0, len0);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 */
export function process_commit(group_id, commit_b64) {
    const ptr0 = passStringToWasm0(group_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(commit_b64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.process_commit(ptr0, len0, ptr1, len1);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @param {string} username
 */
export function save_state_to_storage(username) {
    const ptr0 = passStringToWasm0(username, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.save_state_to_storage(ptr0, len0);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_Deno_05b0c09ddd818904 = function(arg0) {
        const ret = arg0.Deno;
    ...
    imports.wbg.__wbg_String_c728a581f99d8f59 = function(arg0, arg1) {
        const ret = String(arg1);
        const ptr1 = passStringToWasm0(ret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        getDataViewMemory0().setInt32(arg0 + 4 * 1, len1, true);
    ...
    imports.wbg.__wbg___wbg_test_output_writeln_3d38c4dc01294bce = function(arg0) {
        __wbg_test_output_writeln(arg0);
    };
    imports.wbg.__wbg___wbgtest_og_console_log_29b25b5540aa3f64 = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_constructor_8ac4184a07e5c62b = function(arg0) {
    ...
    imports.wbg.__wbg_forEach_fdfa9a663e9c9a9e = function(arg0, arg1, arg2) {
        try {
            ...
            var cb0 = (arg0, arg1, arg2) => {
                ...
                state0.a = 0;
                try {
                    return wasm_bindgen__convert__closures_____invoke__h255a89ae68d7021b(a, state0.b, arg0, arg1, arg2);
                } finally {
                    state0.a = a;
                }
            };
    ...
    imports.wbg.__wbg_name_a2542e2a963acd9c = function(arg0, arg1) {
        const ret = arg1.name;
        const ptr1 = passStringToWasm0(ret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        getDataViewMemory0().setInt32(arg0 + 4 * 1, len1, true);
    ...
    imports.wbg.__wbg_new_c56cf65e94050540 = function() {
        const ret = new Error();
        return ret;
    };
    imports.wbg.__wbg_new_ff12d2b041fb48f1 = function(arg0, arg1) {
        try {
            ...
            var cb0 = (arg0, arg1) => {
                ...
                state0.a = 0;
                try {
                    return wasm_bindgen__convert__closures_____invoke__h1c2f29fb06bfab95(a, state0.b, arg0, arg1);
                } finally {
                    state0.a = a;
                }
            };
    ...
    imports.wbg.__wbg_now_b8cde9800cd52bc7 = function(arg0) {
        const ret = arg0.now();
        return ret;
    };
    imports.wbg.__wbg_performance_6c2c9c79eaf30c45 = function(arg0) {
    ...
    imports.wbg.__wbg_self_1aac27ca448ddd09 = function(arg0) {
        const ret = arg0.self;
        return isLikeNone(ret) ? 0 : addToExternrefTable0(ret);
    };
    ...
    imports.wbg.__wbg_stack_987cd23232c581b5 = function(arg0) {
        const ret = arg0.stack;
        return ret;
    };
    imports.wbg.__wbg_stack_cce263fe73e03130 = function(arg0, arg1) {
        const ret = arg1.stack;
        const ptr1 = passStringToWasm0(ret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        getDataViewMemory0().setInt32(arg0 + 4 * 1, len1, true);
    ...
    imports.wbg.__wbg_stack_e9e97e670e8b416b = function(arg0, arg1) {
        const ret = arg1.stack;
        const ptr1 = passStringToWasm0(ret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        getDataViewMemory0().setInt32(arg0 + 4 * 1, len1, true);
    ...
    imports.wbg.__wbindgen_cast_a788a31e51647739 = function(arg0, arg1) {
        ...
        const ret = makeMutClosure(arg0, arg1, wasm.wasm_bindgen__closure__destroy__h995dd7520031f68d, wasm_bindgen__convert__closures_____invoke__h4319133022181043);
        return ret;
    };
