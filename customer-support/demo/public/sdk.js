"use strict";var CustomerSupport=(()=>{var a=Object.defineProperty;var l=Object.getOwnPropertyDescriptor;var p=Object.getOwnPropertyNames;var h=Object.prototype.hasOwnProperty;var g=(o,e)=>{for(var t in e)a(o,t,{get:e[t],enumerable:!0})},u=(o,e,t,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of p(e))!h.call(o,s)&&s!==t&&a(o,s,{get:()=>e[s],enumerable:!(i=l(e,s))||i.enumerable});return o};var m=o=>u(a({},"__esModule",{value:!0}),o);var w={};g(w,{CustomerSupportWidget:()=>n,default:()=>f});var n=class{constructor(e){this.container=null;this.chatWindow=null;this.isOpen=!1;this.contactId=null;this.conversationId=null;this.messages=[];this.pollingAbortController=null;this.config={apiUrl:"",position:"bottom-right",primaryColor:"#2563eb",welcomeMessage:"Hi! How can we help you today?",...e},this.visitorId=this.getVisitorId(),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>this.init()):this.init()}getVisitorId(){let e="cs_visitor_id",t=document.cookie.split(";");for(let c of t){let[r,d]=c.trim().split("=");if(r===e)return d}let i="v_"+Math.random().toString(36).substring(2)+Date.now().toString(36),s=new Date(Date.now()+365*24*60*60*1e3);return document.cookie=`${e}=${i}; expires=${s.toUTCString()}; path=/; SameSite=Lax`,i}async init(){this.createStyles(),this.createWidget(),await this.initVisitor(),this.startPolling(),this.trackPageView()}createStyles(){let e=document.createElement("style");e.textContent=`
      .cs-widget-container {
        position: fixed;
